    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><strong>NN</strong> Shop</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#"><strong>Call: </strong>09999999999</a></li>
                            <li><a href="#"><strong>Mail: </strong>nhinguyen0602@gmail.com</a></li>
                            <li class="divider"></li>
                ...
                <form class="navbar-form navbar-right" role="search">
                    <div class="form-group">
                        <input type="text" placeholder="Nhập nội dung cần tìm tiếm..." class="form-control">
                    </div>
                    &nbsp; 
                ...
                <div class="main box-border">
                    <div id="mi-slider" class="mi-slider">
                        <ul>
                            ...
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/1.jpg" alt="img01"><h4>Giày</h4>
                            </a></li>
                            <li><a href="#">
                                <img src="assets/ItemSlider/images/2.jpg" alt="img02"><h4>Dép</h4>
                            </a></li>
                            <li><a href="#">
            ...
            <div class="col-md-3">
                <div>
                    ...
                    <ul class="list-group">
                        ...
                        <a class="list-group-item" href="nganhhang.html"> Mobile
					  <span class="label label-primary pull-right">234</span>
                        </a>
                        <a class="list-group-item" href="nganhhang.html">Computers
                      <span class="label label-success pull-right">34</span>
                        </a>
                        <a class="list-group-item"href="nganhhang.html">Tablets
                         <span class="label label-danger pull-right">4</span>
                        </a>
                        <a class="list-group-item"href="nganhhang.html">Appliances
                             <span class="label label-info pull-right">434</span>
                        </a>
                        <a class="list-group-item" href="nganhhang.html">Games & Entertainment
                             <span class="label label-success pull-right">34</span>
                        </a>
                    </ul>
                </div>
...
<!--
            ...
            <div class="col-md-4">
                ...
                <p>
                     38 Đồng Kè<br />
                                    Đà Nẵng, Việt Nam<br />
                    Call: 0999999999<br>
                    Email: nhinguyen0602@gmail<br>
                </p>

                2018 www.shopnhinguyen.com | All Right Reserved
            </div>
    ...
    <div class="col-md-12 end-box ">
        &copy; 2018 | &nbsp; All Rights Reserved | &nbsp; www.shopnhinguyen.com | &nbsp; 
    </div>
    <!-- /.col -->
    <!--Footer end -->
